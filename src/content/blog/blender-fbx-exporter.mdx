...
<BlogImage src={"/blog/preset_objs.png"} alt={"Operator Presets With Selected Object Types"} width={600} caption={"Exporting the Mesh and Armature, instead of all object types."} /><br/>
...
navigated to Blender's `Edit > Preferences`, clicked on the `Add-ons` and `Community` tabs, and clicked on the "Install" button to open a file browser and find 
the Python file. 

Then, I installed and activated the example Add-on:

<BlogImage src={"/blog/simple_custom_panel.png"} alt={"Simple Custom Panel"} width={800} /><br/>
